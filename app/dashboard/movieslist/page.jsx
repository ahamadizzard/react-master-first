...
// import { getMovies } from "@/lib/actions/movie"; // Import API functions
// import { Button } from "@/components/ui/button";
// import { getMoviesNewDB } from "@/lib/apis/server";

// export default function MovieList() {
//     const [movies, setMovies] = useState([]);
//     const [movies_n, setMovies_n] = useState([]);
...
//     }, []);
//     // useEffect(() => {
//     //     const fetchMovies_n = async () => {
//     //         try {
//     //             // const response = await getMovies();
//     //             const response_n = await getMoviesNewDB();
//     //             setMovies(response_n);
//     //         } catch (error) {
//     //             console.error("Failed to fetch movies:", error);
//     //         } finally {
//     //             setIsLoading(false);
